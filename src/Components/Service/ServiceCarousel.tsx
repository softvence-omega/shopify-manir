  ...
  return (
    <div className="relative w-full mx-auto mt-6 md:mt-12 flex items-center">
      <button
        ...
        className="absolute cursor-pointer left-0 top-32 xl:top-1/2 xl:-left-20 z-10 p-2 rounded-full bg-[#42c822] transition disabled:opacity-30"
        aria-label="Previous"
      ...
      <button
        ...
        className="absolute cursor-pointer right-0 top-32 xl:top-1/2 xl:-right-20  z-10 p-2 rounded-full bg-[#42c822] transition disabled:opacity-30"
        aria-label="Next"
