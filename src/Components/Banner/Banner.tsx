...
const Banner = () => {
  ...
  return (
    <section
      id="home"
      className="bg-[linear-gradient(180deg,rgba(66,200,34,0.24)_0%,rgba(66,200,34,0)_100%)] min-h-screen w-full"
    >
      ...
      >
        ...
        >
          {Info.map((text, index) => (
            <span
              key={index}
              className="mx-12 text-xl lg:text-4xl font-semibold uppercase cursor-pointer hover:text-[#42C822] transition-all duration-300 flex justify-center items-center gap-4 "
            >
              {text}
              <svg
